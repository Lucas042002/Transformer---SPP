...
cantidad = 50    # Cambia aquí la cantidad de problemas a generar
...
for idx, rects in enumerate(problemas):
    ...
    placements, altura, rect_sequence, all_states, all_Y_rect, best_placement_states, best_placement_Y_states = result
